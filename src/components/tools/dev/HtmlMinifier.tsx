...
export function HtmlMinifier() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6 bg-slate-900 rounded-2xl shadow-xl text-slate-200">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white">HTML Minifier</h2>
        <p className="text-slate-400 text-sm mt-1">Compress your HTML by removing comments and whitespace.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col space-y-2">
          <div className="flex justify-between items-center">
            <label className="text-sm font-medium text-slate-400">Input HTML</label>
