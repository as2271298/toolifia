...
export const metadata = constructMetadata({
  title: "All Free Online Tools & AI Utilities | Toolifia",
  description:
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="space-y-12">
        {CATEGORIES.map((cat) => {
          ...
          return (
            <section key={cat.slug} id={cat.slug} className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-800">
