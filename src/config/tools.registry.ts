...
export const TOOLS: ToolDef[] = [
  ...
  {
    slug: "ai-humanizer",
    name: "AI Humanizer Free (No Sign Up)",
    category: "ai-tools",
    description: "Free AI text humanizer with no sign up required. Rewrite AI drafts into natural, human prose with varied sentence length and rich vocabulary.",
    icon: "Sparkles",
    featured: true,
    trending: true,
    rating: 4.9,
    ...
    benefits: ["Enhance natural sentence flow and clarity", "Improve readability and narrative rhythm", "Maintain key message integrity without generic filler"],
    howTo: ["Paste your draft or AI-generated text into the input box.", "Select your preferred tone and target output style.", "Click 'Humanize Text' to instantly receive rewritten prose."],
    commonMistakes: ["Using overly short prompts without sufficient context.", "Ignoring tone alignment with target readers."],
    faqs: [
      { question: "How can I humanize AI text for free without sign up?", answer: "Toolifia's AI humanizer is 100% free with zero sign up, no email entry, and no account required. Simply paste your text and generate refined prose instantly." },
      { question: "How does the AI Text Humanizer work?", answer: "It rewrites structural patterns, varies sentence length (burstiness), and replaces predictable AI phrasing (perplexity) while preserving the original meaning." },
      { question: "Can humanized text be guaranteed to bypass all AI detectors?", answer: "No tool can ethically guarantee a 0% score across all third-party detectors due to constantly changing heuristics. Toolifia focuses on genuine human flow, vocabulary variance, and readability." }
    ]
  },
  {
    slug: "ai-detector",
    name: "AI Content Detector Free Online",
    category: "ai-tools",
    description: "Analyze text for AI probability, perplexity, and structural patterns generated by ChatGPT, Claude, or Gemini online for free.",
    icon: "ShieldAlert",
    featured: true,
    trending: true,
    rating: 4.8,
    ...
    benefits: ["Verify originality and phrasing patterns", "Identify overly uniform sentence structures", "Spot repetitive AI transition phrases"],
    howTo: ["Paste your article or passage into the text area.", "Click 'Scan for AI Content'.", "Review the AI probability assessment and highlighted markers."],
    commonMistakes: ["Testing passages under 50 words which lower statistical reliability.", "Treating probabilistic scores as definitive proof of AI generation."],
    faqs: [
      { question: "How do AI content detectors work?", answer: "AI content detectors calculate perplexity (word choice predictability) and burstiness (sentence length diversity) against typical large language model patterns." },
      { question: "What is the best free AI content detector online?", answer: "Toolifia provides an instant, free AI Content Detector with no login required that scans text against GPT-4, Gemini, Claude, and Llama writing signatures." },
      { question: "Can AI detectors produce false positives?", answer: "Yes, formal or academic writing often uses structured grammar and common transitions that can occasionally be flagged as AI patterns." }
    ]
  },
  {
  ...
  // ── SEO TOOLS ────────────────────────────────────────────────────────────
  {
    ...
    name: "Meta Description & Title Checker Free (SEO Generator)",
    category: "seo-tools",
    description: "Free meta title and description checker & tag generator. Preview Google search snippets, test character limits, and generate Open Graph cards.",
    icon: "Search",
    featured: true,
    trending: true,
    rating: 4.9,
    reviewsCount: 2100,
    keywords: ["meta description length checker free", "meta title and description checker free", "meta description checker free", "title tag and meta description length tools", "meta description checker online", "meta tags checker online"],
    ...
    faqs: [
      { question: "What is the recommended meta description length for Google SEO?", answer: "The ideal meta description length is 150 to 160 characters (around 960 pixels). For mobile devices, search results typically truncate descriptions beyond 120 characters." },
      { question: "Can a meta description be the same as page content?", answer: "While you can quote an introductory sentence, writing a unique summary with a clear call-to-action significantly increases click-through rate (CTR) in search results." },
      { question: "Does meta description length directly affect rankings?", answer: "Meta descriptions are not a direct Google ranking factor, but they heavily influence CTR, which directly impacts organic traffic volume." }
    ]
  },
  {
  ...
  },
  {
    ...
    name: "Keyword Density Checker Online Free (Analyzer Tool)",
    category: "seo-tools",
    description: "Analyze keyword density, word frequency ratios, and 1/2/3-word n-grams online for free to prevent search engine over-optimization.",
    icon: "BarChart3",
    featured: true,
    trending: true,
    rating: 4.8,
    ...
    faqs: [
      {
        question: "Is keyword density a direct Google ranking factor?",
        answer: "Google does not use a rigid keyword density quota. However, keeping keyword density around 1% to 2% ensures your topic is clear to search crawlers without triggering over-optimization or keyword-stuffing penalties."
      },
      {
        question: "What is keyword density and why does it matter?",
        answer: "Keyword density measures the percentage of times a target keyword appears relative to the total word count. It helps verify that search terms are naturally distributed throughout your headings, introduction, and body copy."
      },
      {
      ...
      {
        question: "How to check keyword density for free?",
        answer: "Paste your article into Toolifia's Keyword Density Checker. The tool instantly extracts 1-word, 2-word, and 3-word n-grams, filters stop words, and highlights density ratios with zero signup required."
      }
    ]
  },
  {
  ...
  {
    slug: "json-formatter",
    name: "JSON Formatter Online Free (Beautifier & Validator)",
    category: "developer-tools",
    description: "Format, validate, beautify, and minify JSON data online for free with error detection and syntax highlighting. No login required.",
    icon: "Braces",
    featured: true,
    trending: true,
    rating: 4.9,
    reviewsCount: 4200,
    keywords: ["json formatter online free", "json formatter free online", "json formatter online free no login", "how to json format in notepad ++", "json beautifier free online", "json formatter free"],
    ...
    faqs: [
      { question: "How does valid JSON format look like?", answer: "A valid JSON format consists of key-value pairs wrapped in curly braces {}, with double-quoted string keys and supported values (strings, numbers, booleans, arrays, or objects). Example: {\"name\": \"Toolifia\", \"active\": true}." },
      { question: "How to format JSON in Notepad++ or VS Code?", answer: "In VS Code, use the shortcut Shift + Alt + F (Windows) or Shift + Option + F (Mac). Alternatively, use Toolifia JSON Formatter online in your browser with no plugins required." },
      { question: "Why is my JSON failing validation?", answer: "Check for unquoted property keys, single quotes instead of double quotes, or trailing commas after the last element." }
    ]
  },
  {
    slug: "json-to-csv",
  ...
  {
    slug: "base64-encoder",
    name: "Base64 Encoder Online Free (Encode & Decode)",
    category: "security-tools",
    description: "Encode text, images, or binary data into Base64 strings, or decode Base64 back to plain text online for free. 100% client-side.",
    icon: "Binary",
    featured: true,
    trending: false,
    rating: 4.8,
    reviewsCount: 1670,
    keywords: ["base64 encoder online free", "base64 image encoder free", "base64 encoder and decoder online", "how to base64 encode a string", "base64 encoder free", "base64 encoding how does it work"],
    features: ["UTF-8 character support", "Encode / Decode mode toggle", "Image & file to Base64 data URI conversion", "100% in-browser client-side execution"],
    benefits: ["Safely transmit binary data across text-only networks", "Embed small images and SVGs directly in HTML and CSS code", "Zero data sent to external servers"],
    howTo: ["Select 'Encode' or 'Decode' mode.", "Enter input text or upload a file.", "Copy the result or data URI immediately."],
    commonMistakes: ["Confusing Base64 encoding with encryption — anyone can easily decode Base64 strings."],
    faqs: [
      { question: "How does Base64 encoding work?", answer: "Base64 takes binary data and translates it into an ASCII string representation using a 64-character alphabet. Every 3 bytes (24 bits) of data are split into four 6-bit chunks." },
      { question: "How to Base64 encode a string in terminal or Python?", answer: "In Linux/macOS terminal, run: `echo -n 'text' | base64`. In Python: `import base64; base64.b64encode(b'text').decode()`. You can also use Toolifia for instant browser-based encoding with zero setup." },
      { question: "Is Base64 considered encryption?", answer: "No. Base64 is an encoding scheme intended to make binary data safe for transport across email and HTTP systems. It provides zero cryptographic secrecy or security." }
    ]
  },
  {
    slug: "url-encoder",
  ...
  {
    slug: "bmi-calculator",
    name: "BMI Calculator Online Free (By Age & Gender)",
    category: "calculator-tools",
    description: "Calculate your Body Mass Index (BMI), healthy weight range, and WHO category classifications online for free by age, gender, and height.",
    icon: "HeartPulse",
    featured: true,
    trending: false,
    rating: 4.9,
    ...
    features: ["Metric (kg/cm) and Imperial (lbs/inches) units", "WHO BMI category classification gauge", "Ideal weight target range estimation", "Gender & age awareness"],
    benefits: ["Understand body mass metrics quickly", "Track fitness, wellness, and healthy lifestyle targets", "Instant calculations with zero account signup"],
    howTo: ["Select metric (kg/cm) or imperial (lbs/inches) unit system.", "Enter your weight, height, age, and gender.", "Click 'Calculate BMI' to review your index and healthy range."],
    commonMistakes: ["Confusing height in inches with total feet.", "Using adult BMI cutoffs for children under 18."],
    faqs: [
      { question: "Is BMI calculated the same for men and women?", answer: "The standard mathematical formula (weight divided by height squared) is the same for adult men and women. However, women naturally carry higher body fat percentages than men at identical BMI values." },
      { question: "What is a normal BMI range according to WHO?", answer: "According to the World Health Organization (WHO): Underweight is below 18.5, Normal/Healthy is 18.5 to 24.9, Overweight is 25.0 to 29.9, and Obese is 30.0 or greater." },
      { question: "Does the BMI formula change with age?", answer: "Standard adult BMI thresholds apply to ages 20 and up. For children and teenagers aged 2 to 19, BMI percentiles relative to age and sex charts are used instead." }
    ]
  },
  {
    slug: "age-calculator",
  ...
  },
  {
    ...
    name: "Meta Title Length Checker Online Free (SERP Preview)",
    category: "seo-tools",
    description: "Preview how your title tag and meta description look on Google desktop & mobile search results online for free, checking character limits and pixel width.",
    icon: "Eye",
    featured: true,
    trending: true,
    rating: 4.9,
    reviewsCount: 2310,
    keywords: [
      "meta title length checker online",
      "meta title and description length checker",
      "what is meta title character limit",
      "meta title length in pixels",
      "recommended meta title length for seo",
      "meta title length best practices",
      "meta title length checker",
      "meta description length checker free"
    ],
    features: [
    ...
    faqs: [
      {
        question: "What is the meta title character limit with spaces for Google SEO?",
        answer: "The recommended meta title character limit is 50 to 60 characters with spaces (or 580 to 600 pixels). If a title exceeds 600px, Google search snippets will truncate the remaining text with ellipses (...)."
      },
      {
        question: "What is the ideal meta title length in pixels?",
        answer: "The optimal pixel length is between 500px and 580px. Because Google renders search results using proportional fonts (Arial), wider letters (like 'M' or 'W') consume more pixel width than narrow letters (like 'i' or 'l')."
      },
      {
        question: "What is the ideal meta description length for SEO in 2026?",
        answer: "The ideal meta description length is 150 to 160 characters (approximately 960 pixels) for desktop search results, and 110 to 120 characters for mobile SERPs."
      },
      {
        question: "Why does Google truncate titles with ellipses (...)?",
        answer: "Google truncates titles whenever the rendered text exceeds the allocated snippet container boundary (typically 600 pixels). Keeping your primary focus keyword near the front ensures it remains visible even if truncation occurs."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    name: "Loan EMI Calculator Online Free (Payment & Schedule)",
    category: "calculator-tools",
    description: "Calculate monthly loan payments, total interest payable, and full amortization schedules for personal, car, and home loans online for free.",
    icon: "Landmark",
    featured: true,
    trending: true,
    rating: 4.8,
    reviewsCount: 4890,
    keywords: ["loan emi calculator online free", "loan emi calculator app free download", "personal loan emi calculator free", "home loan emi calculator free", "loan comparison calculator with extra payments", "car loan emi calculator free"],
    ...
    faqs: [
      { question: "What is an Equated Monthly Installment (EMI) and how is it calculated?", answer: "An EMI is a fixed monthly payment covering both principal repayment and interest charges. It is calculated with the standard formula: EMI = [P × R × (1+R)^N] / [(1+R)^N - 1], where P is principal, R is monthly interest rate, and N is number of months." },
      { question: "How do extra payments reduce overall loan cost?", answer: "Any additional payments applied directly against principal immediately lower the interest-accruing balance, reducing total interest paid and shortening the payoff schedule." },
      { question: "What is the difference between flat and reducing rate loans?", answer: "In a reducing rate loan, interest is calculated only on the remaining unpaid principal balance each month. In a flat rate loan, interest is charged on the original principal throughout, resulting in a much higher effective APR." }
    ]
  },
  {
  ...
  },
  {
    ...
    name: "Subdomain Finder Online Free (Scanner & API)",
    category: "seo-tools",
    description: "Discover public subdomains, active IP addresses, and DNS record structures for security research and domain auditing online for free.",
    icon: "Globe",
    featured: false,
    trending: true,
    rating: 4.8,
    ...
    features: ["Public DNS certificate transparency lookup", "IP address resolution & ASN mapping", "Download CSV and text list output", "Fast concurrent domain scanner"],
    benefits: ["Audit forgotten dev and staging subdomains for security leaks", "Map competitor infrastructure and multi-subdomain architectures", "Verify DNS record propagation across hostnames"],
    howTo: ["Enter a root domain name (e.g. example.com).", "Click 'Search Subdomains'.", "Review live subdomains with IP addresses and export results."],
    commonMistakes: ["Including `https://` protocol prefix when searching root domains."],
    faqs: [
      { question: "How does a subdomain finder work?", answer: "A subdomain finder queries public Certificate Transparency (CT) logs, historical DNS registries, and certificate authority records to map out all discovered hostnames under an apex domain." },
      { question: "How to check if a subdomain exists for a domain?", answer: "Enter the root domain into Toolifia Subdomain Finder. The scanner queries global DNS servers to verify whether active A or CNAME records respond." },
      { question: "Can you have a subdomain of a subdomain?", answer: "Yes, DNS architecture allows multi-level nested subdomains such as staging.api.example.com, where each level is separated by a period." },
      { question: "Is subdomain searching legal?", answer: "Yes, searching public Certificate Transparency logs and DNS records is standard security auditing, bug bounty reconnaissance, and network research." }
    ]
  },
  {
