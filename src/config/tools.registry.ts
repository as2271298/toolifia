...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    category: "ai-tools",
    description: "Rewrite AI-generated text into more natural, readable language while preserving the original meaning and context.",
    icon: "Sparkles",
    featured: true,
    trending: true,
    rating: 4.9,
    reviewsCount: 1240,
    keywords: ["ai humanizer", "ai text rewriter", "natural language enhancer", "humanize chatgpt", "make ai text human"],
    ...
    faqs: [
      ...
      { question: "Can a specific AI detector score be guaranteed?", answer: "No. AI detection heuristics evolve constantly. Toolifia focuses on improving flow, vocabulary variance, and human readability rather than gaming arbitrary filters." },
  ...
  },
  {
    ...
    category: "ai-tools",
    description: "Analyze text for linguistic predictability, perplexity, and structural markers common in AI-generated writing.",
    icon: "ShieldAlert",
    featured: true,
    trending: true,
    rating: 4.8,
    ...
    faqs: [
      { question: "Can AI detectors be 100% accurate?", answer: "No detector is 100% infallible. AI detectors provide statistical probability indicators based on perplexity and burstiness." },
      { question: "What models does it check against?", answer: "It evaluates patterns typical of large language models including GPT-4, Gemini, Claude, and Llama." }
    ]
  },
  {
